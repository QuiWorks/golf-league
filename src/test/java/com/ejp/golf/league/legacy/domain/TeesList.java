 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{}Tees" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlRootElement(name = "TeesList")
public class TeesList {

    @XmlElement(name = "Tees")
    protected List<Tees> tees;
     ...
     * This is why there is not a <CODE>set</CODE> method for the tees property.
     * 
     * <p>
